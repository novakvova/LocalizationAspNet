...
using RoutedLocaliztionExample.Utils;

namespace RoutedLocaliztionExample.HttpModules
{
    /// <summary>
    ...
    public class LangQueryAppenderModule : IHttpModule
    {
        ...
        public LangQueryAppenderModule()
        {
            ...
            var asmPath = HttpContext.Current.Server.MapPath("~/bin/RoutedLocaliztionExample.dll");
